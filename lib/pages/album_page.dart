...
import 'package:spotify/json/song&pic.dart';
import 'package:spotify/pages/music_details.dart';
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Text(
                             "${index + 1} .  " + songAlbums[index]['title'],style: TextStyle(
                              color: white
                            ),
                            ),
                          ),
                         ...
                         child: Row(
                           ...
                           children: [
                             Text(
                          songAlbums[index]['duration'],style: TextStyle(
                             color: grey,
                               fontSize: 14
                             ),
                             ),
